        ...
        <div className="mx-auto px-6 max-w-6xl text-gray-500">
          <div className="text-center">
            <h2 className="text-3xl text-gray-950 dark:text-white font-semibold">
              Quickstart with our Auth Template
            </h2>
            <p className="mt-6 text-gray-700 dark:text-gray-300">
              These are the tools and technologies used in this template
            </p>
          </div>
          <div className="mt-12 grid sm:grid-cols-2 lg:grid-cols-3 gap-x-4 gap-y-3.5">
            ...
            <div className="relative group overflow-hidden p-8 rounded-xl bg-white border border-gray-200 dark:border-gray-800 dark:bg-gray-900">
              ...
              <div className="relative">
                ...
                <div className="mt-6 pb-6 rounded-b-[--card-border-radius]">
                  <p className="text-gray-700 dark:text-gray-300">
                    Supabase for creating a postgres database for production
                  </p>
                </div>
            ...
            <div className="relative group overflow-hidden p-8 rounded-xl bg-white border border-gray-200 dark:border-gray-800 dark:bg-gray-900">
              ...
              <div className="relative">
                ...
                <div className="mt-6 pb-6 rounded-b-[--card-border-radius]">
                  <p className="text-gray-700 dark:text-gray-300">
                    Next JS app router with incredible server components and server actions
                  </p>
                </div>
                <div className="flex gap-3 -mb-8 py-4 border-t border-gray-200 dark:border-gray-800">
                  <a
            ...
            <div className="relative group overflow-hidden p-8 rounded-xl bg-white border border-gray-200 dark:border-gray-800 dark:bg-gray-900">
              ...
              <div className="relative">
                ...
                <div className="mt-6 pb-6 rounded-b-[--card-border-radius]">
                  <p className="text-gray-700 dark:text-gray-300">
                    Prisma ORM for handling Schema of database smoothly
                  </p>
                </div>
                <div className="flex gap-3 -mb-8 py-4 border-t border-gray-200 dark:border-gray-800">
                  <a
            ...
            <div className="relative group overflow-hidden p-8 rounded-xl bg-white border border-gray-200 dark:border-gray-800 dark:bg-gray-900">
              ...
              <div className="relative">
                ...
                <div className="mt-6 pb-6 rounded-b-[--card-border-radius]">
                  <p className="text-gray-700 dark:text-gray-300">
                    Tailwind CSS for writing stunning styles like a Genius
                  </p>
                </div>
                <div className="flex gap-3 -mb-8 py-4 border-t border-gray-200 dark:border-gray-800">
                  <a
